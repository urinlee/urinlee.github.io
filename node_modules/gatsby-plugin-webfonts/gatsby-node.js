...
var onPreBootstrap = /*#__PURE__*/function () {
  var _ref2 = (0, _asyncToGenerator2.default)( /*#__PURE__*/_regenerator.default.mark(function _callee(_ref, pluginOptions) {
    var cache, createContentDigest, store, pathPrefix, reporter, directory, cacheFolder, publicFolder, options, optionsCacheKey, cachedOptions, filter;
    return _regenerator.default.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            cache = _ref.cache, createContentDigest = _ref.createContentDigest, store = _ref.store, pathPrefix = _ref.pathPrefix, reporter = _ref.reporter;
            if (!(0, _lodash.default)(pluginOptions.fonts)) {
              _context.next = 3;
              break;
            }
          ...
          case 10:
            ...
            _context.next = 14;
            return (0, _webFonts.default)(options, reporter);
          case 14:
            _context.next = 16;
