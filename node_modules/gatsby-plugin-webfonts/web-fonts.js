...
var _selfHosted = _interopRequireDefault(require("./modules/selfHosted"));
function webFonts(_x, _x2) {
  return _webFonts.apply(this, arguments);
}
function _webFonts() {
  _webFonts = (0, _asyncToGenerator2.default)( /*#__PURE__*/_regenerator.default.mark(function _callee2(options, reporter) {
    ...
    return _regenerator.default.wrap(function _callee2$(_context2) {
      while (1) {
        switch (_context2.prev = _context2.next) {
          case 0:
            modules = {
              google: (0, _google.default)(options, 1),
              google2: (0, _google.default)(options, 2),
              selfHosted: (0, _selfHosted.default)(options, reporter)
            };
          ...
          case 4:
            ...
            _context2.next = 7;
            return merge(cssStrings.flat().join(""));
          case 7:
            css = _context2.sent;
